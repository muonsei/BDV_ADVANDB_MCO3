...
public class MainController extends Controller {
	...
	public void load() throws ViewManagerException {
		...
		if (isFirstLoad()) {
			...
			ObservableList<String> regions = FXCollections.observableArrayList(dbHelper.getAllRegions());
			...
			insertRegion.valueProperty().addListener(new ChangeListener<String>() {
				...
				public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
					ArrayList<Record> records = dbHelper.getAllCountryRowByRegion(newValue);
